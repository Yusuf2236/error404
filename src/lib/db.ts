...
// Path to the JSON database file (shared between the customer site and admin panel).
// Override with BOOKINGS_DB_PATH so both Next.js apps point at the exact same file.
