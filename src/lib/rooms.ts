...
export const ROOMS: Room[] = [
    {
        ...
        description: { en: "Located on the 15th floor with a 270-degree view of Tashkent City.", uz: "15-qavatda joylashgan, Tashkent City-ga 270 darajali ko'rinish.", ru: "Расположен на 15-м этаже с 270-градусным видом на Tashkent City." },
        price: 550,
    ...
    },
    {
        ...
        description: { en: "Located near the famous Broadway street. Features a private green pointer.", uz: "Mashhur Broadway ko'chasi yaqinida joyhazigan. Shaxsiy yashil hovliga ega.", ru: "Находится рядом со знаменитым Бродвеем. Включает частный зеленый дворик." },
        price: 320,
